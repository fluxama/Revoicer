...
@implementation RevoicerAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   // }
    ...
    void *ptr = [PdBase openFile:@"pd-Revoicer.pd"
                            path:[[NSBundle mainBundle] resourcePath]];
    if (!ptr) { 
        NSLog(@"Failed to open patch!");
    }
    self.audioController.active = YES;
    [PdBase sendFloat:200000 toReceiver:@"setBuffersize"];
    int b = [PdBase arraySizeForArrayNamed:@"soundbuffer"];
    
    CCLOG(@"buffer size: %i",b);
    ...
    instrumentScene.instrument_name = @"Revoicer";
